...
#MAX_LOOPS = 100000 #None        # the vehicle loop can abort after this many iterations, when given a positive integer.
# 
# #CAMERA
###CAMERA_TYPE = "WEBCAM"   # (PICAM|WEBCAM|CVCAM|CSIC|V4L|MOCK) ## ok mit webcam ##
...
CAMERA_TYPE = "CSIRBX"   # my own camera class
IMAGE_W = 160
IMAGE_H = 120
...
STEERING_LEFT_PWM = 460 #480 #460         #pwm value for full left steering
STEERING_RIGHT_PWM = 280 # 290        #pwm value for full right steering
# 
# #THROTTLE
THROTTLE_CHANNEL = 0            #channel on the 9685 pwm board 0-15
# ok vor umbau THROTTLE_FORWARD_PWM = 500      #pwm value for max forward throttle
# ok vor umbau THROTTLE_STOPPED_PWM = 380 #370      #pwm value for no movement
# ok vor umbau THROTTLE_REVERSE_PWM = 310 #310 #220      #pwm value for max reverse throttle
THROTTLE_FORWARD_PWM = 500      #pwm value for max forward throttle
THROTTLE_STOPPED_PWM = 420 #380 #370      #pwm value for no movement
THROTTLE_REVERSE_PWM = 310 #380 #310 #220      #pwm value for max reverse throttle
# 
...
ROI_CROP_TOP = 50 # pi wide angle                    #the number of rows of pixels to ignore on the top of the image
#ROI_CROP_TOP = 30 # webcam 720                    #the number of rows of pixels to ignore on the top of the image
