...
IMAGE_W = 224 #160  # for a CSIC camera this must be 224
IMAGE_H = 224 #120  # for a CSIC camera this must be 224
...
DRIVE_TRAIN_TYPE = "I2C_SERVO"#"I2C_SERVO" # I2C_SERVO|DC_STEER_THROTTLE|DC_TWO_WHEEL|DC_TWO_WHEEL_L298N|SERVO_HBRIDGE_PWM|PIGPIO_PWM|MM1|MOCK
# 
# #STEERING
STEERING_CHANNEL   = 1            #channel on the 9685 pwm board 0-15
STEERING_LEFT_PWM  = 440 #460         #pwm value for full left steering
STEERING_RIGHT_PWM = 290 #280 #290        #pwm value for full right steering
# 
...
BATCH_SIZE = 16 #128                #how many records to use when doing one pass of gradient decent. Use a smaller number if your gpu is running out of memory.
...
AUTO_CREATE_NEW_TUB = True #False     #create a new tub (tub_YY_MM_DD) directory when recording or append records to data directory directly
# 
# #LED
