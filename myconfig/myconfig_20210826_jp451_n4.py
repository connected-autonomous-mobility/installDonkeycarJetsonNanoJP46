...
# 
# #CAMERA
CAMERA_TYPE = "CSIRBX"   # (PICAM|WEBCAM|CVCAM|CSIC|V4L|D435|MOCK|IMAGE_LIST)
IMAGE_W = 224#160 #224 #1280 #160 #224  # for a CSIC camera this must be 224
IMAGE_H = 224#120 #224 #720 #120 #224  # for a CSIC camera this must be 224
...
# 
# #IMU
HAVE_IMU = False #True                #when true, this add a Mpu6050 part and records the data. Can be used with a
